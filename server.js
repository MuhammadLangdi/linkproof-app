                ...
                <div id="mainContent" class="hidden">
                    ...
                    <div id="createProofSection" class="mb-8 mt-8">
                        ...
                        <form id="uploadForm" class="flex flex-col items-center mb-6">
                            <input type="email" id="email" placeholder="Your Email Address (Optional)" class="bg-gray-700 text-white py-2 px-4 rounded-lg w-full max-w-lg mb-4 focus:outline-none focus:ring-2 focus:ring-blue-500" />
